                ...
                <div className="max-w-screen-xl px-4 mx-auto 2xl:px-0 py-4">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center lg:space-x-2 relative">
                            <button onClick={toggleCartView} id="myCartDropdownButton1" data-dropdown-toggle="myCartDropdown1" type="button" className="inline-flex items-center rounded-lg justify-center p-2 hover:bg-teal-700 dark:hover:bg-gray-700 text-sm font-medium leading-none text-white dark:text-white">
                            ...
                            <div id="myCartDropdown1" className="hidden absolute right-0 top-full mt-2 z-10 w-80 max-w-sm space-y-4 overflow-hidden rounded-lg bg-teal-800 p-4 antialiased shadow-lg dark:bg-gray-800">
                                ...
                                <div className="grid grid-cols-2">
                                <div>
                                    <a href="#" className="truncate text-sm font-semibold leading-none text-white dark:text-white hover:underline">Apple Watch SE</a>
                            ...
                            <div className="grid grid-cols-2">
                                <div>
                                    <a href="#" className="truncate text-sm font-semibold leading-none text-white dark:text-white hover:underline">Sony Playstation 5</a>
                            ...
                            <div className="grid grid-cols-2">
                                <div>
                                    <a href="#" className="truncate text-sm font-semibold leading-none text-white dark:text-white hover:underline">Apple iMac 20"</a>
                        ...
                        <button id="userDropdownButton1" data-dropdown-toggle="userDropdown1" type="button" className="inline-flex items-center rounded-lg justify-center p-2 hover:bg-teal-700 dark:hover:bg-gray-700 text-sm font-medium leading-none text-white dark:text-white">
